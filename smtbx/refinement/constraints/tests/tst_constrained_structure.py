...
class sucrose_test_case(test_case):
  ...
  def __init__(self, m):
    ...
    #This result is no longer good because fp and fdp are now also added to the
    #parameter array all. Thus the parameter indices are shifted up by up
    #to 90 (2x the number of atoms in sucrose).
    ...
    self.expected_mapping_to_grad_fc = (
            ...
            394, 395, 396, 92, 7, 8, 9, 93, 94, 95, 96, 97, 98, 397, 398, 399, 
            99, 14, 15, 16, 100, 101, 102, 103, 104, 105, 400, 401, 402, 106, 
            21, 22, 23, 107, 108, 109, 110, 111, 112, 403, 404, 405, 113, 76, 
            77, 78, 114, 115, 116, 117, 118, 119, 28, 29, 30, 120, 121, 122, 
            123, 124, 125, 406, 407, 408, 126, 35, 36, 37, 127, 128, 129, 130, 
            131, 132, 409, 410, 411, 133, 42, 43, 44, 134, 135, 136, 137, 138, 
            139, 412, 413, 414, 140, 49, 50, 51, 141, 142, 143, 144, 145, 146, 
            415, 416, 417, 147, 66, 67, 68, 148, 149, 150, 151, 152, 153, 56, 
            57, 58, 154, 155, 156, 157, 158, 159, 418, 419, 420, 160, 3, 4, 5, 
            161, 162, 163, 164, 165, 166, 424, 425, 426, 167, 10, 11, 12, 168, 
            169, 170, 171, 172, 173, 427, 428, 429, 174, 17, 18, 19, 175, 176, 
            177, 178, 179, 180, 421, 422, 423, 181, 430, 431, 432, 182, 24, 25, 
            26, 183, 184, 185, 186, 187, 188, 433, 434, 435, 189, 63, 64, 65, 
            190, 191, 192, 193, 194, 195, 436, 437, 438, 196, 69, 70, 71, 197, 
            198, 199, 200, 201, 202, 52, 53, 54, 203, 204, 205, 206, 207, 208, 
            442, 443, 444, 209, 439, 440, 441, 210, 45, 46, 47, 211, 212, 213, 
            214, 215, 216, 445, 446, 447, 217, 38, 39, 40, 218, 219, 220, 221, 
            222, 223, 448, 449, 450, 224, 73, 74, 75, 225, 226, 227, 228, 229, 
            230, 451, 452, 453, 231, 31, 32, 33, 232, 233, 234, 235, 236, 237, 
            454, 455, 456, 238, 457, 458, 459, 239
            )
